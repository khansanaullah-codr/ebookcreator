    ...
    >
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
            <img
                src={coverImageUrl}
                alt={book.title}
                className="w-full aspect-[18/27] object-cover transition-transform duration-500 group-hover:scale-105"
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-orange-500 via-amber-500 to-rose-500 opacity-0 group-hover:opcaity-100 transition-opacity duration-300" />
    </div>
  )
}
