...
const Features = () => {
  return <div id="features" className="relative py-24 lg:py-32 bg-white overflow-hidden">
    ...
    <div className="aboslute inset-0 bg-gradient-to-b from-violet-50/50 via transparent to-purple-50/50"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Our platform is packed with powerful feature to help you write,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-violet-200 transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/10 hover:-translate-1">
                <div className="absolute inset-0 bg-gradient-to-br from-violet-50/0 to-purple-50/0 group-hover:from-violet-50/50 group-hover:to-violet-50/30 rounded-2xl transition-all duration-300"></div>
