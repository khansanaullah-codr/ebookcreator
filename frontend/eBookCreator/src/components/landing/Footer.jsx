        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5 space-y-6 ">
            ...
            <div className="flex items-center space-x-3 pt-2">
              ...
              <a href="https://linkedin.com" className="w-10 h-10 bg-white/5 hover:bg-violet-600 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110" aria-label="Linkedin">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://github.com" className="w-10 h-10 bg-white/5 hover:bg-violet-600 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110" aria-label="Github">
