          ...
          >
            {chapters.length === 0 ? (
              ...
              chapters.map((chapter, index) => (
                <div
                  key={index}
                  className="group p-4 border-gray-200 rounded-xl hover:border-gray-300 hover:shadow-sm transition-all bg-white"
                >
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <input
                      ...
                      className="flex-1 text-base text-gray-900 bg-transparent border-none focus:outline-none focus:ring-0 p-0"
                    />
                    <button
