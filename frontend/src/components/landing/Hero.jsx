...
const Hero = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-violet-50 via-white to-purple-50 overflow-hidden">
      ...
      {/* <div className="aboslute top-20 left-10 w-64 h-64 bg-violet-200/30 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 w-96 h-96 bg-purple-200/20 rounded-full blur-3xl animate-pulse delay-700"></div> */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="max-w-xl space-y-8">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-6xl font-bold text-gray-900 leading-tight tracking-tight">
              Create Stunning
              <span className="block mt-2 bg-gradient-to-r from-violet-600 to-violet-600 bg-clip-text text-transparent">
                EBooks in Minutes
              </span>
            </h1>
