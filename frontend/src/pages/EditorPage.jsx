    ...
    <>
      <div className="flex bg-slate-50 font-sans relative min-h-screen">
          ...
          >
            ...
            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
              <div className="absolute top-0 right-0 -mr-12 pt-2">
                <button
                  type="button"
                  className="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none fous:ring-2 focus:ring-inset focus:ring-white"
                  onClick={() => setIsSidebarOpen(false)}
                >
        ...
        <main className="flex-1 h-full flex flex-col">
          <header className="sticky top-0 z-1- bg-white/80 backdrop-blur-sm border-b border-slate-200 p-3 flex justify-between items-center">
